            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hardhat_network_helpers_1.time.latest()];
                    case 1:
        ...
        it("Should set the right unlockTime", function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, (0, hardhat_network_helpers_1.loadFixture)(deployOneYearLockFixture)];
                        case 1:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = chai_1.expect;
                            return [4 /*yield*/, hardhat_1.ethers.provider.getBalance(lock.address)];
                        case 2:
        ...
        it("Should fail if the unlockTime is not in the future", function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, hardhat_network_helpers_1.time.latest()];
                        case 1:
                            latestTime = _a.sent();
                            return [4 /*yield*/, hardhat_1.ethers.getContractFactory("Lock")];
                        case 2:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, hardhat_network_helpers_1.time.increaseTo(unlockTime)];
                            case 2:
                                // We can increase the time in Hardhat Network
                                _b.sent();
